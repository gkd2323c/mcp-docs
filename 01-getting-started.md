# MCP Documentation -- 01 Getting Started
...
MCP is a stateful protocol</Tooltip> that requires lifecycle management. The purpose of lifecycle management is to negotiate the capabilities</Tooltip> that both client and server support. Detailed information can be found in the [specification](/specification/latest/basic/lifecycle), and the [example](#example) showcases the initialization sequence.
...
# Design Principles
Source: https://modelcontextprotocol.io/community/design-principles
